...
class testQuantCastSol(unittest.TestCase):
	...
	def test_addToMap(self):
		...
		self.logStore = quantcast.StoreLog()
		self.logStore.addToMap("2000-01-01","SAZuXPGUrfbcn5UA")
		self.assertEqual(self.logStore.hashmap, expected,'StoreLog.addToMap() failed to process another cookie/timestamp datapoint')
